...
async def _(event):
    if ispay[0] == "yes":
        ...
        await sedthon.send_message('@eeobot', '/start')
        await asyncio.sleep(10)
        msg0 = await sedthon.get_messages('@eeobot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(10)
        msg1 = await sedthon.get_messages('@eeobot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await sedthon.get_messages('@eeobot', limit=1)
